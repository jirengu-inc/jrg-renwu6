...
/* WEBPACK VAR INJECTION */(function($) {      var newCarousel=(function(){
            function Carousel(){
...
/* WEBPACK VAR INJECTION */(function($) {        var newGotop=(function(){
              function Gotop(){
            ...
            //return newGotop requirejs定义模块后返回的接口，这个接口名会作为参数传入主模块加载后的回调函数内
...
/* WEBPACK VAR INJECTION */(function($) {				var newWaterfall=(function(){
                function Waterfall(){
          this.perPageCount=6
          this.curPage=1
          this.init()
...
var $=__webpack_require__(4);//这里加载的jquery模块是webpack.config.js里定义的jquery插件名称
var carsoule=__webpack_require__(1);//./相对路径，相对当前index.js文件所在目录为起始目录，模块名为js文件名
